export default function Icon() {
  return (
    <svg width="32" height="32" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <radialGradient id="spacinsGlow" cx="50%" cy="50%" r="60%" fx="40%" fy="40%">
          <stop offset="0%" stopColor="#38bdf8" stopOpacity="0.95" />
          <stop offset="55%" stopColor="#6366f1" stopOpacity="0.75" />
          <stop offset="100%" stopColor="#0f172a" stopOpacity="0.9" />
        </radialGradient>
        <linearGradient id="spacinsCore" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#bae6fd" />
          <stop offset="100%" stopColor="#38bdf8" />
        </linearGradient>
      </defs>
      <rect width="128" height="128" rx="32" fill="#020617" />
      <circle cx="64" cy="64" r="46" fill="url(#spacinsGlow)" />
      <path
